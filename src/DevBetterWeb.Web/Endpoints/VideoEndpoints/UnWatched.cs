...
public class UnWatched : EndpointBaseAsync
	.WithRequest<string>
	.WithActionResult
{
	...
	public UnWatched(IRepository<ArchiveVideo> archiveVideoRepository, UserManager<ApplicationUser> userManager,
	...
	[HttpGet("videos/unwatched/{videoId}")]
