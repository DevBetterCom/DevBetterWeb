...
{
	public AdminUpdatesWebhook(IDiscordWebhookService discordWebhookService, IOptions<DiscordWebhookUrls> optionsAccessor): base(discordWebhookService, optionsAccessor.Value.AdminUpdates!)
	{
