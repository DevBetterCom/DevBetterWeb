...
public class AddSubtitleToVideoService : BaseAsyncApiCaller
  ...
  .WithResponse<AnimatedThumbnailsResponse>
{
  ...
  public AddSubtitleToVideoService(HttpService httpService, ILogger<AddAnimatedThumbnailsToVideoService> logger)
  {
